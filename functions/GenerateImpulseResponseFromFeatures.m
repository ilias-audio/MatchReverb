function [irTimeDomain] = GenerateImpulseResponseFromFeatures(MeasuresStruct, delays, input_gain, output_gain, diff_power)
    ...
    t_initial_spectrum_values = t_initial_spectrum_values + diff_power;
