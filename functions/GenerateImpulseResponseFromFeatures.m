...
%   Detailed explanation goes here
    ...
    %rt30 = InterpolationFilterGains(MeasuresStruct.SPECTRUM_T30', MeasuresStruct.FREQ_T30, OctaveCenterFreqs);
    ...
    %t_initial_spectrum_values = InterpolationFilterGains(t_initial_spectrum', MeasuresStruct.FREQ_T30, OctaveCenterFreqs_for_power);

    t_initial_spectrum_values = MeasuresStruct.INITIAL_SPECTRUM;
    t_initial_spectrum_values = t_initial_spectrum_values * 2; % energy to amplitude
