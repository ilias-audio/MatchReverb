function cost = reverb_fitness_hybrid_order_16(TargetIRMeasures, x) 
    ...
    g_ir_time_domain = GenerateHybridResponseFromFeatures(TargetIRMeasures, g_delays, g_input_gain, g_output_gain, g_direct_gain);
